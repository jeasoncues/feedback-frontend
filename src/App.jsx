...
import CreateCompanies from './Components/Companies/CreateCompanies'
import {BrowserRouter, Routes, Route} from 'react-router-dom'
import ShowBranchOffices from './Components/BranchOffices/ShowBranchOffices'
import CreateBranchOffice from './Components/BranchOffices/CreateBranchOffices'
...
function App(){
    ...
    <div className='App'>
      <BrowserRouter>
        <Routes>
          ...
          <Route path='/companies' element={<ShowCompanies/>} />
          <Route path='/companies/create' element={ <CreateCompanies/> } />
          <Route path='/branchoffices/create' element={ <CreateBranchOffice/> } />
          <Route path='/branchoffices/:id' element={ <ShowBranchOffices/> } />
        </Routes>
      </BrowserRouter>
    </div>
  )
  ...
  //         <img src="src/logo.png" width="400" height="50" />
  ...
  //           <button
  //             type="submit"
  //             className="w-full bg-[#eb0003] py-2 px-4 text-white rounded-md hover:bg-[#fcf0f0] hover:text-gray-600 transition-colors"
  //           >
  //             Acceder
  //           </button>
  //         </div>
